...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        ...
        <div class="w3-center w3-padding-16" >List of Customer</div>
    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
            ...
            <div class="table-responsive" style="overflow-x:auto; width: 100%;">
                ...
                foreach ($customerData as $row) {
                    echo "<tr>";
                    echo "<td style='vertical-align: middle;'>" . $row["c_code"] . "</td>";
                    echo "<td style='vertical-align: middle;'>"; 
                    // Edit and delete buttons side by side
                    echo "<div class='action-buttons'>";
                    echo "<a href='add_customer.php' class='add-button'><i class='fas fa-plus-circle'></i></a>";
                    echo "<a href='edit_customer.php?id=" . $row["c_code"] . "' class='edit-button'><i class='fas fa-pencil-alt'></i></a>";
                    echo "<a onclick='confirmDelete(\"" . $row["c_code"] . "\")' class='delete-button'><i class='fas fa-trash-alt'></i></a>";                    echo "</div>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
