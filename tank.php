...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        ...
        <div class="w3-center w3-padding-16" >List of Tank</div>
    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
            ...
            <div class="table-responsive" style="overflow-x:auto; width: 100%;">
                ...
                foreach ($tankData as $row) {
                    echo "<tr>";
                    echo "<td style='vertical-align: middle;'>" . $row["t_id"] . "</td>";
                    echo "<td style='vertical-align: middle;'>"; 
                    // Edit and delete buttons side by side
                    echo "<div class='action-buttons'>";
                    echo "<a href='add_tank.php' class='add-button'><i class='fas fa-plus-circle'></i></a>";
                    echo "<a href='edit_tank.php?id=" . $row["t_id"] . "' class='edit-button'><i class='fas fa-pencil-alt'></i></a>";
                    echo "<a href='javascript:void(0);' class='delete-button' onclick='confirmDelete(" . $row["t_id"] . ")'><i class='fas fa-trash-alt'></i></a>";
                    echo "</div>";
                    echo "</td>";
                    echo "</tr>";
                }
    ...
    function confirmDelete(id) {
        ...
        if (confirm("Are you sure you want to delete the tank record?")) {
            // Redirect to delete script with the record ID if the user confirms
            window.location.href = "delete_tank.php?id=" + id;
        }
    }
