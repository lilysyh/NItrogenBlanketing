...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        ...
        <div class="w3-center w3-padding-16" >List of Products</div>
    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
            ...
            <div class="table-responsive" style="overflow-x:auto; width: 100%;">
                ...
                foreach ($productData as $row) {
                    echo "<tr>";
                    echo "<td style='vertical-align: middle;'>" . $row["p_code"] . "</td>";
                    echo "<td style='vertical-align: middle;'>"; 
                    // Edit and delete buttons side by side
                    echo "<div class='action-buttons'>";
                    echo "<a href='add_product.php' class='add-button'><i class='fas fa-plus-circle'></i></a>";
                    echo "<a href='edit_product.php?id=" . $row["p_code"] . "' class='edit-button'><i class='fas fa-pencil-alt'></i></a>";
                  
                    echo "<a onclick='confirmDelete(\"" . $row["p_code"] . "\")' class='delete-button'><i class='fas fa-trash-alt'></i></a>";                 
...
function confirmDelete(id) {
    ...
    if (confirm("Are you sure you want to delete the product record?")) {
